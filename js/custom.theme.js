...
(function ($) {
    ...
    themeData.fnResponsiveMenu = function () {
        ...
        if (themeData.MenuOverTrigger.length) {
            ...
            themeData.MenuOverTrigger.hover(function () {
                $('.navi-trigger-hamberg-line').velocity("scaleXin", {
                    stagger: 100
                });
            }, function () {
                $('.navi-trigger-hamberg-line').velocity({
                    scaleX: 1
                });
            });
        }
    ...
    themeData.fnSingleGalleryFilled = function () {
        ...
        if (singleCol2TextWrap.is('.pull-right')) {
            $('.single-gallery-wrap-inn').css('margin-left', '0px').velocity({
                opacity: 1
            });
            ...
            $('.single-gallery-wrap-inn').css('margin-right', '0px').velocity({
                opacity: 1
            });
    ...
    themeData.fnSingleAnima = function () {
        ...
        if ($('.social-bar').length) {
            ...
            _social_bar.waypoint(function (direction) {
                if (direction === 'down') {
                    _social_bar.find('.fa').velocity('transition.expandIn', {
                        stagger: 160
                    });
                }
                this.destroy();
